...
import RewindProgressDots from "./RewindProgressDots";
  ...
  return (
    <>
      ...
      <div className="flex min-h-screen flex-col items-center justify-center bg-neutral-50 px-4 py-6 md:px-20 lg:px-40 dark:bg-neutral-950">
        ...
        <div className="sticky top-20 z-50 mb-8 bg-neutral-50 py-4 dark:bg-neutral-950">
          <RewindProgressDots currentStage={0} totalStages={4} />
        </div>
        ...
        <div className="flex w-full max-w-4xl flex-col items-center gap-8">
          <div className="text-center">
            ...
            <div className="mb-8 text-3xl font-semibold text-rose-500 dark:text-rose-400">
              {playstyle.type}
            </div>
          </div>
